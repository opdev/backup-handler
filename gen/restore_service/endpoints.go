...
// NewEndpoints wraps the methods of the "Restore Service" service with
// endpoints.
...
// Use applies the given middleware to all the "Restore Service" service
// endpoints.
...
// "create" of service "Restore Service".
func NewCreateEndpoint(s Service) goa.Endpoint {
	return func(ctx context.Context, req interface{}) (interface{}, error) {
		...
		vres := NewViewedRestoreresult(res, "default")
		return vres, nil
	}
}
...
// "update" of service "Restore Service".
...
// "delete" of service "Restore Service".
