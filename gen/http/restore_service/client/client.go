...
//
// Restore Service client HTTP transport
//
// Command:
...
// NewClient instantiates HTTP clients for all the Restore Service service
// servers.
func NewClient(
	scheme string,
	host string,
...
// Create returns an endpoint that makes HTTP requests to the Restore Service
...
func (c *Client) Create() goa.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("Restore Service", "create", err)
		}
		return decodeResponse(resp)
	}
}

// Get returns an endpoint that makes HTTP requests to the Restore Service
// service get server.
func (c *Client) Get() goa.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("Restore Service", "get", err)
		}
		return decodeResponse(resp)
	}
}

// Update returns an endpoint that makes HTTP requests to the Restore Service
...
func (c *Client) Update() goa.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("Restore Service", "update", err)
		}
		return decodeResponse(resp)
	}
}

// Delete returns an endpoint that makes HTTP requests to the Restore Service
...
func (c *Client) Delete() goa.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("Restore Service", "delete", err)
		}
		return decodeResponse(resp)
	}
}
